...
describe('TrustPanel', () => {
  it('says "not yet measured" for a null fragility instead of showing 0', () => {
    render(<TrustPanel trust={{ confidence: 0.81, vacuity: 0.62, dissonance: 0.1, fragility: null }} />);
  ...
  it('shows a real zero as a number, distinct from not measured', () => {
    render(<TrustPanel trust={{ confidence: 0.81, vacuity: 0.62, dissonance: 0.1, fragility: 0 }} />);
